/**
 * @fileoverview This file contains all the js needed for the userLogin log page
 */


/**
 * This function is used when the user clicks select-all button in user list
 * and the check boxes in user list is all checked
 */
function selectAll() {
  $('input[type="checkbox"][name="userchkbox"]').prop('checked',
      true).trigger('change');
}
...
/**
 * This function is called the page have loaded completely
 */
$(document).ready(function() {
  ...
  /*To get the log of user login in DB */
  $.post('../../log/userLogin', {
